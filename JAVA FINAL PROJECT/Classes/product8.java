...
public class product8 extends JFrame implements ActionListener
{
	...
	public product8()
	{
		...
		booktypeLabel = new JLabel("English Novel Book");
		...
		proimgBtn.setIcon(new ImageIcon("Image/Robinson.jpg"));
