...
public class product11 extends JFrame implements ActionListener
{
	...
	public product11()
	{
		...
		headingLabel = new JLabel("Good Luck Pencil Box Micky Multi Colour");
		headingLabel.setBounds(600, 190, 1400, 40);
		headingLabel.setFont(myFont);
		panel.add(headingLabel);
		
		
		takaLabel = new JLabel("BDT 126TK ");
		takaLabel.setBounds(610, 380, 270, 40);
		takaLabel.setFont(myFont);
		panel.add(takaLabel);
		
		proinfoLabel = new JLabel("Manufacturer: Good Luck Stationery");
		proinfoLabel.setBounds(610, 230, 290, 40);
		panel.add(proinfoLabel);
		
		proinfo2Label = new JLabel("SKU: RTH00660");
		...
		booktypeLabel = new JLabel(" Geometry Box & Others");
		...
		proimgBtn.setIcon(new ImageIcon("Image/pencilbox.jpg"));
