...
public class product2 extends JFrame implements ActionListener
{
	...
	public product2()
	{
		...
		headingLabel = new JLabel("Himu 1st part");
		...
		proinfo2Label = new JLabel("Originally published in 1997");
		...
		proimgBtn.setIcon(new ImageIcon("Image/Himu.jpg"));
