...
public class product10 extends JFrame implements ActionListener
{
	...
	public product10()
	{
		...
		headingLabel = new JLabel("SSC Preparation Essentials Pack - 9 Items");
		headingLabel.setBounds(600, 190, 1400, 40);
		headingLabel.setFont(myFont);
		panel.add(headingLabel);
		
		
		takaLabel = new JLabel("BDT 475TK ");
		...
		ratLabel = new JLabel("4.8 rating");
		ratLabel.setBounds(610, 420, 240, 40);
		panel.add(ratLabel);
		
		booktypeLabel = new JLabel("Stationery Collection");
		...
		proimgBtn.setIcon(new ImageIcon("Image/SSC.jpg"));
