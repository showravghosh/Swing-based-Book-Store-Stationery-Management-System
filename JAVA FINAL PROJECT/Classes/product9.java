...
public class product9 extends JFrame implements ActionListener
{
	private ImageIcon img;
	private JLabel headingLabel, takaLabel,proinfoLabel,proinfo2Label,quanLabel,
	        ratLabel,booktypeLabel,imgLabel;
	private JButton proimgBtn, buyBtn,backbtn,logout;
	...
	public product9()
	{
		...
		ratLabel = new JLabel("4.00 rating");
		ratLabel.setBounds(610, 420, 240, 40);
		panel.add(ratLabel);
		
		booktypeLabel = new JLabel("Category: Geometry box");
		booktypeLabel.setBounds(205, 80, 500, 60);
		booktypeLabel.setFont(new Font("Serif", Font.BOLD, 30));
		panel.add(booktypeLabel);
		
		
		proimgBtn = new JButton("Login");
		proimgBtn.setIcon(new ImageIcon("Image/geometry.jpg"));
