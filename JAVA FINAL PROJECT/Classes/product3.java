...
public class product3 extends JFrame implements ActionListener
{
	...
	public product3()
	{
		...
		headingLabel = new JLabel("Diner Sheshe");
		...
		proinfoLabel = new JLabel("Novel by Humayun Ahmed");
		proinfoLabel.setBounds(610, 230, 290, 40);
		panel.add(proinfoLabel);
		
		proinfo2Label = new JLabel("Originally published in 2003");
		...
		booktypeLabel = new JLabel("Bangla Novel Book");
		...
		proimgBtn.setIcon(new ImageIcon("Image/Diner-sheshe.jpg"));
