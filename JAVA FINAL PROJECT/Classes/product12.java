...
public class product12 extends JFrame implements ActionListener
{
	...
	public product12()
	{
		...
		headingLabel = new JLabel("ARTISTRO Watercolor Paint Set");
		...
		proinfoLabel = new JLabel("48 Vivid Colors in Portable Box");
		proinfoLabel.setBounds(610, 230, 290, 40);
		panel.add(proinfoLabel);
		
		proinfo2Label = new JLabel("Including Metallic and Fluorescent Colors");
		...
		booktypeLabel = new JLabel("Kids' Watercolor Paint");
		...
		proimgBtn.setIcon(new ImageIcon("Image/watercolour.jpg"));
